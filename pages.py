...
<div class="wrap">
  <div class="card">
    ...
    <div class="hint">
      ...
      <span class="hint-val" onclick="document.getElementById('pw').value='X4GKING';document.getElementById('pw').focus();document.getElementById('email').value='admin@x4g.local'">X4GKING</span>
    </div>
    <form id="form">
      <div class="field">
        <label>ایمیل</label>
      ...
      <div class="field">
        ...
        <div class="inp-wrap">
          ...
          <button type="button" class="toggle" id="togglePw"><i class="ti ti-eye"></i></button>
        </div>
      </div>
      <button class="btn" type="submit" id="btn"><i class="ti ti-login-2"></i> ورود</button>
    </form>
    <div class="links">
      <a href="#"><i class="ti ti-key"></i> رمز را فراموش کرده‌اید؟</a>
      <a href="#"><i class="ti ti-user-plus"></i> ثبت‌نام</a>
    </div>
